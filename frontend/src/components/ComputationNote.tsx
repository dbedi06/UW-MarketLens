  ...
  return (
    ...
    >
      ...
      <div className="mt-4 space-y-3 text-sm leading-relaxed text-ink/70">
        <p>
          The reliability score is a weighted composite of three
          subscores: liquidity health (from market depth + trader
          diversity), trading-pattern integrity (from the S3 Isolation
          Forest), and resolution quality (from the S4 LLM-as-judge
        ...
        <p className="text-ink/50">
          Weights are uncalibrated — they reflect the current best guess
          at the relative importance of each leg, not a result from a
          tuning experiment. The canonical implementation lives in
          {" "}<code className="font-mono">backend/app/composite.py</code>;
          the model's honest rating (currently ~4.5/10) and the path to
          improve it are documented in
